...
$2y - x$ of a pair $x < y$ within a block falls in the other team's
territory. Our main result eliminates this candidate.
...
the same three axioms are satisfiable whenever $M \not\equiv 0 \pmod 8$,
