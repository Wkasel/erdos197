...
two results are consistent, and together they locate the obstruction at the
block bottoms exactly. Permutations of $\Z$ and of subsets of $\Z^+$
...
use on bounded ladders, the transfer lock, and the flood induction.) The mod-$8$ condition is sharp:
