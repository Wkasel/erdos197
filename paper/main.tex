...
Machine-verified facts (witnesses and solver logs in the repository): deferral states exist
...
I thank Jesse Geneson for reading an earlier version of this paper and for
several corrections, two of which are recorded at the points where they
apply: the balance lemma (Lemma~\ref{lem:balance}), which an earlier draft
stated in a false symmetric form, and the class-sink proposition, which an
earlier draft asserted with an $r$-dependent cycle structure. His comments
did not extend to a verification of Theorem~\ref{thm:main} or of the chain
leading to it, and responsibility for all statements in this paper,
including any error, is mine alone.
...
\texttt{reproduce.sh}, a script that re-runs the verification stack for the
main-theorem chain (the schema audits of Remark~\ref{rem:c3machine}, the
