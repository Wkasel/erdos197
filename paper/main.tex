...
\subsection{Self-similar witnesses and pumping}

% TODO(pending computation): exact/eventual scale-invariance
% (u \prec w \iff 4u \prec 4w) is satisfiable at X = 256 (audited witness);
% status at X = 1024 pending. Pumping theorem: a two-layer self-similar witness
% with uniform boundary handling generates an infinite solution; write in full
% when the witness lands.
